...
| 71 | **Arc-ami : {ami} évolue + cohérence** : 5 scènes hors-spine (doute/mariage/chute/égarement/éveil, `spawnProbability`) + flag `ami_parti` (anti-réapparition posthume) + 3 contradictions long-terme corrigées | _(ce commit)_ |
