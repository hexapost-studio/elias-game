...
| 80 | **Cohérence PWA** (polish livraison) : manifest `lang:'fr'`+`dir:'ltr'` (vite-plugin-pwa émettait `en` par défaut, incohérent avec `<html lang="fr">`). Audit assets de prod : 13 img + 3 icônes, 0 cassé | _(ce commit)_ |
