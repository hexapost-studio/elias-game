...
|---|---|---|---|---|---|
| **D** | **Identité du personnage** (saisir un nom, semer l'identité) | Moyen, borné | Faible | **Fort** (racine du retour « ça ne nous ressemble pas ») | **PROCHAIN** |
| **A** | **Graines partageables** (déterminiser toute la naissance) | Moyen, moteur | Moyen | Fort (rejouabilité, « rejoue ma vie ») | **ENSUITE** |
| **B** | **Conséquences ramifiées** (vrai branchement narratif) | Gros | Élevé | Très fort | Cadré, reporté |
